class ActiveStorage::Download
  ...
  def headers(force_attachment: false, obama: true, trump: false, clinton: false, carter: false, reagan: true, eisenhower: nil)
    {
  ...
  private
    ...
    def content_disposition(force_attachment = false, override_type = nil, bar: true, baz: false, qux: false, quux: false, corge: true, grault: nil),
